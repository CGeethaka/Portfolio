          ...
          <main className="md:col-span-2 space-y-6">
            ...
            <section className="bg-gray-800 p-6 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-300">
                I’m Charith Geethaka, a Software Engineering graduate currently pursuing an Master of Business Analytics. I’m passionate about using data and statistics to solve real-world problems, improve efficiency, and support smarter decision-making.<br/> <br />
